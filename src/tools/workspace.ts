...
import { loadConfig, detectProjectStructure, validateConfig } from '../lib/config.js';
 ...
 */
export async function workspace_summary(): Promise<ToolResponse> {
 ...
 */
export async function workspace_search_code(pattern: string): Promise<ToolResponse> {
  const startTime = Date.now();
 ...
 */
export async function workspace_git_diff_summary(): Promise<ToolResponse> {
  const startTime = Date.now();
 ...
 * Detect module path
 */
export async function workspace_detect_module_path(): Promise<ToolResponse> {
  const startTime = Date.now();
 ...
 */
export async function workspace_detect_bindings_path(): Promise<ToolResponse> {
  const startTime = Date.now();
